                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div>
                                <p></p>
                                <h5>
                                    Please enter desired amount to deposit.
                                </h5>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div id="image-container">
                                <img src="https://c4.wallpaperflare.com/wallpaper/972/56/42/check-pen-keyboard-wallpaper-preview.jpg" class="img-fluid" alt="Responsive image">
                            </div>
                        </div>
                    </div>
                </div>
